...
const galleryItems = [
    { src: 'NAO.jpg', caption: 'First edition cover of El Filibusterismo' },
    { src: 'NAO.jpg', caption: 'Portrait of José Rizal' },
    { src: 'NAO.jpg', caption: 'Portrait of José Rizal' },
    { src: 'NAO.jpg', caption: 'Original manuscript page' },
    { src: 'NAO.jpg', caption: 'Rizal writing El Filibusterismo' },
    { src: 'NAO.jpg', caption: 'Historical photo from the period' }
];

function showImage(imageSrc) {
    // Find the clicked gallery item
    const clickedItem = document.querySelector(`.gallery-item img[src="${imageSrc}"]`);
    const caption = clickedItem.closest('.gallery-item').querySelector('.gallery-caption').textContent;
    ...
    currentImageIndex = galleryItems.findIndex(item => item.src === imageSrc);
}
...
document.addEventListener('DOMContentLoaded', function() {
    ...
    document.querySelectorAll('.gallery-item').forEach(item => {
        item.addEventListener('click', function() {
            ...
            const selectedImage = document.getElementById('viewer-image');
            selectedImage.src = imageSrc;
            selectedImageContainer.style.display = 'flex'; // Show the selected image container
        });
    });
